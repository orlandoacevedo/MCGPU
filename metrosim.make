...
metrosim_double : build
	...
	nvcc src/Metropolis/ParallelSim/ParallelBox.cu $(Include) -c -g -o obj/src/Metropolis/ParallelSim/ParallelBox.o
	nvcc src/Metropolis/ParallelSim/ParallelCalcs.cu $(Include) -c -g -o obj/src/Metropolis/ParallelSim/ParallelCalcs.o
...
metrosim_single : build
	...
	nvcc src/Metropolis/ParallelSim/ParallelBox.cu $(Single) $(Include) -c -g -o obj/src/Metropolis/ParallelSim/ParallelBox.o
	nvcc src/Metropolis/ParallelSim/ParallelCalcs.cu $(Single) $(Include) -c -g -o obj/src/Metropolis/ParallelSim/ParallelCalcs.o
	nvcc -o bin/$(AppName) $(Single) -g -pg -lcudart obj/src/Applications/Application.o obj/src/Applications/CommandParsing.o \
								  obj/src/Metropolis/Simulation.o obj/src/Metropolis/SerialSim/SerialBox.o \
								  obj/src/Metropolis/Utilities/IOUtilities.o obj/src/Metropolis/Utilities/StructLibrary.o \
								  obj/src/Metropolis/Utilities/MathLibrary.o obj/src/Metropolis/Utilities/DeviceQuery.o
