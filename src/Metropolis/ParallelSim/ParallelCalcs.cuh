...
namespace ParallelCalcs
{
    ...
    __global__ void calcInterMolecularEnergy_NLC(MoleculeData *molecules, AtomData *atoms, int currentMol, int otherMol, int counter, Real *energies, int maxMolSize);
