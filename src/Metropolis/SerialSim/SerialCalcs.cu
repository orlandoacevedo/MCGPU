...
/**
	...
	energy.
*/
Real SerialCalcs::calc_energy_NLC(Molecule *molecules, Environment *enviro){
...
__global__ void SerialCalcs::calcEnergy_NLC(Molecule *molecules, Environment *enviro, int *head, int *lscl, Real *totalEnergy)
{
