 ...
 */
std::string buildT3pDimoneCommand(std::string MCGPU, std::string configFile, std::string outputName, bool series, bool neighborlist, bool errorExpected) {
	return buildCommand(MCGPU, configFile, outputName, series, neighborlist, errorExpected, "test/unittests/MultipleSolvents/t3pdimoneTests");
}
/**
 ...
 */
void createT3pDimoneConfigFile(std::string MCGPU, std::string fileName, std::string primaryAtomIndexString) {
	
	ConfigFileData settings = ConfigFileData(26.15, 26.15, 26.15, 298.15, .12, 100000, 256, "resources/bossFiles/oplsaa.par", 
		"test/unittests/MultipleSolvents/t3pdimoneTests/t3pdimone.z", "test/unittests/MultipleSolvents/t3pdimoneTests",
		11.0, 12.0, 12345);
...
TEST (t3pdimoneTest, OnePrimaryIndex)
{
    ...
    system(buildT3pDimoneCommand(MCGPU, "t3pdimone1MPI.config", "t3pdimone1MPI", true, false, false).c_str());
...
{
	std::string MCGPU = getMCGPU_path();
	system(buildT3pDimoneCommand(MCGPU, "t3pdimone1MPI.config", "t3pdimone1MPI-GPU", false, false, false).c_str());
	double expected = -1810;
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimone1MPI.config", "t3pdimone1MPI-NL", true, true, false).c_str());
    double expected = -1810;
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimone1MPI.config", "t3pdimone1MPI-NL-GPU", false, true, false).c_str());
    double expected = -1810;
...
TEST (t3pdimoneTest, TwoPrimaryIndex)
{
    ...
    system(buildT3pDimoneCommand(MCGPU, "t3pdimone2MPI.config", "t3pdimone2MPI", true, false, false).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimone2MPI.config", "t3pdimone2MPI-GPU", false, false, false).c_str());
    double expected = -1770;
...
TEST (t3pdimoneTest, MultipleSolventDefinition)
{
    ...
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneMulSolvent.config", "t3pdimoneMulSolvent.txt", true, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneMulSolvent.config", "t3pdimoneMulSolvent-GPU.txt", false, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
	createT3pDimoneConfigFile(MCGPU, "t3pdimoneMulSolventMPI.config", "[1,2],[3,4]");
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneMulSolventMPI.config", "t3pdimoneMulSolventMPI.txt", true, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneMulSolventMPI.config", "t3pdimoneMulSolventMPI-GPU.txt", false, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
	createT3pDimoneConfigFile(MCGPU, "t3pdimoneSingleMultipleIndexes.config", "1,[1,2]");
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneSingleMultipleIndexes.config", "t3pdimoneSingleMultipleIndexes.txt", true, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneSingleMultipleIndexes.config", "t3pdimoneSingleMultipleIndexes-GPU.txt", false, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
	createT3pDimoneConfigFile(MCGPU, "t3pdimoneSingleMultipleIndexes2.config", "[1,2],1");
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneSingleMultipleIndexes2.config", "t3pdimoneSingleMultipleIndexes2.txt", true, false, true).c_str());
...
{
    std::string MCGPU = getMCGPU_path();
    system(buildT3pDimoneCommand(MCGPU, "t3pdimoneSingleMultipleIndexes2.config", "t3pdimoneSingleMultipleIndexes2-GPU.txt", false, false, true).c_str());
